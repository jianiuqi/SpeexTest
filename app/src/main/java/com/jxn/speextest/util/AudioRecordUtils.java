package com.jxn.speextest.util;
...
public class AudioRecordUtils {
	...
	class AudioRecordThread implements Runnable {
		...
		public void run() {
			...
			AudioFileUtils.raw2spx(mAudioRaw, mAudioSpx);
			AudioFileUtils.spx2raw(mAudioSpx, AudioFileUtils.getDecodeRawFilePath());
			AudioFileUtils.raw2Wav(AudioFileUtils.getDecodeRawFilePath(), AudioFileUtils.getDecodeWavFilePath(), bufferSizeInBytes);
		}
	}
